<div class="navbar navbar-expand-xl navbar-dark bg-indigo navbar-static px-0">
    ...
    <div class="d-flex w-100 w-xl-auto overflow-auto overflow-xl-visible scrollbar-hidden border-top border-top-light-100 border-top-xl-0 order-1 order-xl-0">
        <ul class="navbar-nav flex-row text-nowrap mx-auto">
            <li class="nav-item">
                <a href="/mahasiswa/f/{{$kelas->id}}/forum" class="navbar-nav-link @if($route == 'f') active @endif">
            ...
            <li class="nav-item">
                <a href="/mahasiswa/a/{{$kelas->id}}/absensi" class="navbar-nav-link @if($route == 'a') active @endif">
            ...
            <li class="nav-item">
                <a href="/mahasiswa/m/{{$kelas->id}}/materi" class="navbar-nav-link @if($route == 'm') active @endif">
            ...
            <li class="nav-item">
                <a href="/mahasiswa/t/{{$kelas->id}}/tugas" class="navbar-nav-link @if($route == 't') active @endif">
            ...
            <li class="nav-item">
                <a href="/mahasiswa/n/{{$kelas->id}}/nilai" class="navbar-nav-link @if($route == 'n') active @endif">
