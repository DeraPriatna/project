...
<div class="row">
    ...
    <div class="col-lg-8 pt-1">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/dosen/{{$kelas->id}}/uas/store" method="POST" enctype="multipart/form-data">
                    @csrf                   
                    <div class="form-group form-group-floating row">
                        <i class="icon-pen6 icon-m pt-2 col-lg-2"></i>
                        <div class="col-lg-10">
                            <div class="form-group-feedback form-group-feedback-right">
                                <input type="text" name="judul" class="form-control form-control-outline" style="background-color: #fff" readonly value="Ujian Akhir Semester (UAS)">
