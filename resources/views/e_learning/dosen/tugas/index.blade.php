...
<div class="row">
    ...
    <div class="col-lg-8">
        ...
        <a href="/dosen/{{$kelas->id}}/tugas/create" class="btn btn-primary btn-lg">
                        ...
                        <div class="list-icons">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/dosen/{{$kelas->id}}/tugas/edit/{{$item->id}}" class="dropdown-item"><i class="icon-pencil3"></i> Edit</a>
