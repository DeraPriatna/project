...
<div class="row">
    ...
    <div class="col-lg-8 pt-1">
        <div class="card">
            ...
            <div class="card-body">
                <form action="/dosen/{{$kelas->id}}/materi/update/{{$item->id}}" method="POST" enctype="multipart/form-data">
                    @csrf                   
                    ...
                    <div class="form-group form-group-floating row">
                        ...
                        <div class="col-lg-10">
                            <div class="position-relative">
                                <textarea class="form-control form-control-outline" name="deskripsi" autocomplete="off" placeholder="">{{$item->deskripsi}}</textarea>
                    ...
                    <div class="form-group form-group-floating row">
                        ...
                        <div class="col-lg-10">
                            <iframe width="240" src="/storage/materi/{{$item->file}}" frameborder="1"></iframe>
                            <br>{{$item->file}}
                        </div>
                    </div>
