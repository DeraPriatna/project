						...
						@if(count($items) == 0)
							<div class="flex-fill">
								...
								<div class="text-center mb-4">
									...
									<p>Gunakan forum untuk membagikan pengumuman <br>dan menjawab pertanyaan anggota kelas.</p>
								</div>
								<!-- /error title -->
									...
									<ul class="media-list">
										<li class="media">
											...
											<div class="media-body">
												...
												<a href="/dosen/f/{{$kelas->id}}/forum/{{$item->id}}/view" style="color: #333">{{$item->judul}}</a>
											</div>
										</li>
									</ul>
								</div>
...
<div id="modal_buat_forum" class="modal fade" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form action="/dosen/{{$kelas->id}}/forum/store" class="form-horizontal" method="POST">
                @csrf
